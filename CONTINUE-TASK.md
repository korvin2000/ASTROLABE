...
- Further candidate search at `2cb9372`: [proposal §8](OUT-OF-ORDER-PROPOSAL-TASKS.md#8-повторный-отбор-пять-новых-кандидатов-на-checkpoint-2cb9372) contains five new PROPOSED kernels OOO-05–OOO-09; use its updated ranking only when implementation is requested. The normal queue, task count and inactive override remain unchanged.
