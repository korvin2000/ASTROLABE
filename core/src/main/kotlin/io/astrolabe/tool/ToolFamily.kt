...
public object ToolOps {
     ...
     * kb.propose since P4.1.3; bmap, delegate/collect/propose arrive later). `verify.review` is the campaign-scope human review path (P3.5.2, D-23); the review cell is P4.4.3.
     */
