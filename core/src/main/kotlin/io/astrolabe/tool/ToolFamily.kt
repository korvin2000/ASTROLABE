...
public object ToolOps {
    ...
    /** Everything an S0 implementing cell may call in Stage A (refs/importers/impact/bmap, transform, review, delegate/collect/propose, kb.propose arrive later). */
    public val implementingS0: ToolMask = ToolMask(
        all - setOf("look.refs", "look.importers", "look.impact", "look.bmap", "edit.transform", "verify.review", "task.delegate", "task.collect", "task.propose", "kb.propose"),
    )
}
